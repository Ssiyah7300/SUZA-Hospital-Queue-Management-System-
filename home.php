...
<head>
  ...
  <link rel="stylesheet" href="styles/bootstrap3/bootstrap.css">
  <script src="styles/bootstrap3/bootstrap.min.js"></script>
  <link rel="stylesheet" type="text/css" href="styles/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
  <!--==home img==-->
     <link rel="stylesheet" href="styles/home_img.css">
    <!--home img==-->
  <style>
  <style>
    footer {
            ...
            <div class="row">
              ...
              <!--===center detail side===-->
                <div class="col-lg-9">
                  ...
                  <!--===home img===-->
                  <div class="one"> 
                    <label class="textoverimage" style="background-image:url(img/pict1.png);">
                      <input type="checkbox">
                  ...
                  <div class="one"> 
                    <label class="textoverimage" style="background-image:url(img/pict3.png);">
                      <input type="checkbox">
                  ...
                  <div class="one"> 
                    <label class="textoverimage" style="background-image:url(img/pict4.png);">
                      <input type="checkbox">
