...
<head>
  ...
  <!--=====table data =====-->
    <link rel="stylesheet" href="table/style_table.css">
    <script src="table/script1.js"></script>
    <script src="table/script2.js"></script>
    <script src="table/o.js"></script>
    <!--=====table data =====-->

    <!--==home img==-->
     <link rel="stylesheet" href="styles/css/home_img.css">
    <!--home img==-->
  <style>
  <style>
    footer {
